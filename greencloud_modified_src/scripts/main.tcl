...
# dichiaro la lista degli utenti
array set clouduser_ {}
...
#$ns at 0.1 "$clouduser_(0) start"
#$ns at 20 "$clouduser_(1) start"
#$ns at 30 "$clouduser_(2) start"
#$ns at 40 "$clouduser_(3) start"
